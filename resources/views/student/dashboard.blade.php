                    ...
                    @foreach($courses as $course)
                        <div class="col-lg-4 serv-w3mk mt-5">
                            <div class="w3pvtits-services-grids">
                                ...
                                <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: {{Auth::user()->course_prograss($course->id)}}%;" aria-valuenow="{{Auth::user()->course_prograss($course->id)}}" aria-valuemin="0" aria-valuemax="100">{{Auth::user()->course_prograss($course->id)}}%</div>
                                </div>
