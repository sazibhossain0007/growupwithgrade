		...
		<form role="form" action="{{ route('library.store') }}" method="post" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="author" placeholder="Enter Author name" value=""> 
				...
				<div class="form-group">
					...
					<textarea type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="description" placeholder="Enter name" value=""> </textarea>
